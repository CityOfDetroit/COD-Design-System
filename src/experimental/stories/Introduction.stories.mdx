...
<p>
  ...
  in development and should be considered unstable. They are provided for preview and testing purposes only. Please note:
</p>
...
<div className="link-list">
  ...
  <a
    className="link-item"
    href="https://github.com/jedgar1mx/COD-Design-System"
    target="_blank"
  >
