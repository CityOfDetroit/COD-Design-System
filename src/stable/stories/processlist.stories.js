...
export default {
  ...
  args: {
    ...
    step1Content: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Morbi commodo, ipsum sed pharetra gravida, orci magna rhoncus neque.',
    step2Title: 'Proceed to the second step',
    step2Content: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Morbi commodo, ipsum sed pharetra gravida, orci magna rhoncus neque, id pulvinar odio lorem non turpis.',
    step3Title: 'Complete the step-by-step process',
    step3Content: 'Nullam sit amet enim. Suspendisse id velit vitae ligula volutpat condimentum. Aliquam erat volutpat. Sed quis velit.',
    maxWidth: '600px',
  },
};
...
Default.parameters = {
  docs: {
    description: {
      story: 'The default process list displays steps with numbered square indicators and connecting lines.',
    },
  },
};
...
export const NoTextCustomSizing = () => html`
  <div style="max-width: 600px;">
    <cod-process-list class="custom-sizing-no-text">
      <cod-process-list-item>
        <p slot="heading" style="font-size: 1.5rem; line-height: 1.2; margin: 0;">Start a process.</p>
      </cod-process-list-item>
      
      <cod-process-list-item>
        <p slot="heading" style="font-size: 1.5rem; line-height: 1.2; margin: 0;">Proceed to the second step.</p>
      </cod-process-list-item>
      
      <cod-process-list-item>
        <p slot="heading" style="font-size: 1.5rem; line-height: 1.2; margin: 0;">Complete the step-by-step process.</p>
      </cod-process-list-item>
    </cod-process-list>
  </div>
`;
...
NoTextCustomSizing.parameters = {
  docs: {
    description: {
      story: 'Process list with only headings and custom sizing for a more minimal appearance.',
    },
  },
};
  ...
  <div style="max-width: 600px;">
    <cod-process-list>
      <cod-process-list-item>
        ...
        <p>Understand what permits and documentation you need for your project.</p>
      </cod-process-list-item>
      
      <cod-process-list-item>
        <h4 slot="heading">Gather documents</h4>
        <p>Collect all necessary paperwork, including plans, specifications, and proof of insurance.</p>
      </cod-process-list-item>
      
      <cod-process-list-item>
        <h4 slot="heading">Submit application</h4>
        <p>Complete the application form and submit with all required documents and fees.</p>
      </cod-process-list-item>
      
      <cod-process-list-item>
        <h4 slot="heading">Review process</h4>
        <p>City staff will review your application and may request additional information.</p>
      </cod-process-list-item>
      
      <cod-process-list-item>
        <h4 slot="heading">Receive permit</h4>
        <p>Once approved, you'll receive your permit and can begin your project.</p>
      </cod-process-list-item>
    </cod-process-list>
  </div>
`;
...
FiveSteps.parameters = {
  docs: {
    description: {
      story: 'A more complex process with five steps showing how the component scales.',
    },
  },
};
  ...
  <div style="max-width: 650px;">
    <cod-process-list>
      <cod-process-list-item>
        ...
        <ul>
          <li><strong>Property survey</strong> - Shows exact boundaries and easements</li>
          <li><strong>Site plan</strong> - Detailed drawing of proposed changes</li>
          <li><strong>Budget estimate</strong> - Including materials and labor costs</li>
        </ul>
        <p><em>Note: Some projects may require additional documentation.</em></p>
      </cod-process-list-item>
      ...
      <cod-process-list-item>
        ...
        <ul>
          <li>Online through our <a href="#" style="color: #005ea2;">permit portal</a></li>
          <li>In person at City Hall (Monday-Friday, 8AM-5PM)</li>
          <li>By mail to: Permits Department, 123 Main St, Detroit, MI 48201</li>
        </ul>
        <p><strong>Processing time:</strong> 5-10 business days for standard applications.</p>
      </cod-process-list-item>
      ...
      <cod-process-list-item>
        ...
        <p style="background: #fcfcfcff; padding: 1rem; border-left: 4px solid #d3d3d3ff; margin-top: 1rem;">
          <strong>Important:</strong> Work must be completed within one year of permit issuance.
        </p>
      </cod-process-list-item>
    </cod-process-list>
  </div>
...
WithComplexContent.parameters = {
  docs: {
    description: {
      story: 'Process list with rich content including lists, links, emphasis, and callout boxes.',
    },
  },
};