...
export const Basic = () => html`
  <cod-listgroup data-tag="ul">
    ...
    <cod-listgroup-item data-tag="li" data-text="An item"> </cod-listgroup-item>
...
export const Links = () => html`
  <cod-listgroup data-tag="div">
    <cod-listgroup-item
      data-tag="a"
      data-url="#"
      data-text="The current link item"
      data-current="true"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
    ...
    <cod-listgroup-item
      data-tag="a"
      data-url="#"
      data-text="A fourth link item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="a"
      data-url="#"
      data-text="A disabled link item"
      data-disabled="true"
    >
    </cod-listgroup-item>
  </cod-listgroup>
...
export const Button = () => html`
  <cod-listgroup data-tag="div">
    ...
    <cod-listgroup-item
      data-tag="button"
      data-text="A disabled button item"
      data-disabled="true"
    >
    </cod-listgroup-item>
  </cod-listgroup>
...
export const NumberedCustom = () => html`
  <cod-listgroup data-tag="ol" data-numbered="true">
    <cod-listgroup-item
      data-tag="li"
      data-extra-classes="d-flex justify-content-between align-items-start"
    >
...
export const Variants = () => html`
  <cod-listgroup data-tag="ul">
    <cod-listgroup-item
      data-tag="li"
      data-text="A simple default list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="primary"
      data-text="A simple primary list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="secondary"
      data-text="A simple secondary list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="success"
      data-text="A simple success list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="danger"
      data-text="A simple danger list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="warning"
      data-text="A simple warning list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="info"
      data-text="A simple info list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="light"
      data-text="A simple light list group item"
    >
    </cod-listgroup-item>
    <cod-listgroup-item
      data-tag="li"
      data-background-color="dark"
      data-text="A simple dark list group item"
    >
    </cod-listgroup-item>
  </cod-listgroup>
`;
