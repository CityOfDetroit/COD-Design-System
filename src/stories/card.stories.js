...
export const CardStyles = () => html`
  <cod-card
    data-id="card-primary"
    data-extra-classes="text-bg-primary"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-secondary"
    data-extra-classes="text-bg-secondary"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-success"
    data-extra-classes="text-bg-success"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <cod-card
    data-id="card-danger"
    data-extra-classes="text-bg-danger"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-warning"
    data-extra-classes="text-bg-warning"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <cod-card
    data-id="card-info"
    data-extra-classes="text-bg-info"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <cod-card
    data-id="card-light"
    data-extra-classes="text-bg-light"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <cod-card
    data-id="card-dark"
    data-extra-classes="text-bg-dark"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
...
export const Border = () => html`
  <cod-card
    data-id="card-border-primary"
    data-extra-classes="border-primary"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-border-secondary"
    data-extra-classes="border-secondary"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-border-success"
    data-extra-classes="border-success"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-border-danger"
    data-extra-classes="border-danger"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-border-warning"
    data-extra-classes="border-warning"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-border-info"
    data-extra-classes="border-info"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-border-light"
    data-extra-classes="border-light"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
  ...
  <br />
  <cod-card
    data-id="card-border-dark"
    data-extra-classes="border-dark"
    data-width="18em"
  >
    <cod-card-header>
      <span>Header</span>
