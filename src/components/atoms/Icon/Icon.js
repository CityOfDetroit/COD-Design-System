export default class Icon extends HTMLElement {
  ...
  getIcon(icon, size) {
    switch (icon) {
      ...
      case 'list-task':
        return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-task" viewBox="0 0 16 16">
      ...
      case 'journals':
        return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journals" viewBox="0 0 16 16">
